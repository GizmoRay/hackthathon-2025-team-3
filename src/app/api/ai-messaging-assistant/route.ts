	...
	while (attempts < maxAttempts) {
		try {
			const response = await fetch(
				`https://api.copy.ai/api/workflow/WCFG-41696c28-28bd-467f-a5e9-74cb31ee9220/run/${runId}`,
				{
					method: "GET",
					headers: {
...
export async function POST(req: NextRequest) {
	try {
		...
		const initResponse = await fetch(
			"https://api.copy.ai/api/workflow/WCFG-41696c28-28bd-467f-a5e9-74cb31ee9220/run",
			{
				method: "POST",
				headers: {
					Accept: "application/json",
